...
void SCVars::InitCVars(IConsole* pConsole)
{
	...
	*/
	...
	pConsole->Register("mp_chat", &mp_chat, 2, OPTIONAL_SYNC, "Sets chat features support (0: old chat, 1: new chat without server support, 2: new chat with partial server support, 3: new chat with full server support)");
