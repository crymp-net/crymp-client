 ...
 *																	*
 ********************************************************************/
// History: Jan.05 edited to get defines for EAX Morphing by Tomas Neumann
...
#define EAXLISTENER_DEFAULTFLAGS                                                                                       \
	(EAXLISTENERFLAGS_DECAYTIMESCALE | EAXLISTENERFLAGS_REFLECTIONSSCALE |                                         \
	 EAXLISTENERFLAGS_REFLECTIONSDELAYSCALE | EAXLISTENERFLAGS_REVERBSCALE | EAXLISTENERFLAGS_REVERBDELAYSCALE |   \
